		...
		<div class="row no-gutters">
			...
			<div class="col-9 bg-warning">
				<div class='header-greet'>
					<span><i class="fa">&#xf007;</i> 안녕하세요 ${manage_name}님</span>
					<li class="nav-item"><a class="nav-link" href="manage_login.do">로그인</a></li>
					<a href='manage_logout.do' class='logout-btn'><i class="fa">&#xf011;</i></a>
				</div>
			</div>
		</div>
		<div>
					...
					<div class="container">
						...
						<div class="admin-menu">
							<ul class="nav flex-column">
								...
								<li class="nav-item"><a class="nav-link" href="manage_userList.do">사용자
										관리</a></li>
								<li class="nav-item"><a class="nav-link" href="#">숙소 관리</a></li>
								<li class="nav-item"><a class="nav-link" href="#">게시판
										관리</a></li>
