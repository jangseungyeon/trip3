...
<body>
	...
	<c:if test="${not empty u_room.room_img_no2}"><div><button id="moveBackToImgNo1Btn" onclick="f_moveBackToImgNo1()">대표 이미지로 돌아가기</button></div></c:if>
	...
	<div id="u_room_review">
		<div id="review_title"><h4 style="font-weight: 600;">후기</h4></div>
			...
			<div class="review_box">
				...
				<div>
				<textarea style="resize: none;" rows="5" cols="30" name="review_content" class="review_txtarea" disabled><%=review_content%></textarea>
				</div>
				</div>
				</div>
			...
			<div class="review_box">
				...
				<div>
				<span class="review_txtarea"><%=review_content%></span>
				</div>
				</div>
				</div>
			</div>
