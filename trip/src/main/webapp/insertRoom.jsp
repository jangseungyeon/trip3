...
<br>
<div>
<input name="room_img" type="file" id="room_img" onchange="readThisImg(this);" />
</div>
</div>
...
<div id="room_points_q">저희 사이트에 등록시 숙박시설 마일리지는 다음과 같습니다.(숙박 1박당 가격의 0.5%)</div>
<br>
<div>
